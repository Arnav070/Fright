...
export const bookingsToSeedFromImageBase: TempBookingSeedData[] = [
  { quotationRefCustomer: 'ABC Limited', quotationRefPol: 'Chennai', quotationRefPod: 'Long Beach', quotationRefEquipment: '20GP', customerName: 'ABC Limited', pol: 'Chennai', pod: 'Long Beach', equipment: '20GP', type: 'Export', buyRate: findBuyRate('Chennai', 'Long Beach', '20GP','HLCU'), sellRate: 1100, status: 'Booked' },
  ...
  { quotationRefCustomer: 'DEF Limited', quotationRefPol: 'Nhava Sheva', quotationRefPod: 'Felixstowe', quotationRefEquipment: '40HC', customerName: 'DEF Limited', pol: 'Nhava Sheva', pod: 'Felixstowe', equipment: '40HC', type: 'Export', buyRate: findBuyRate('Nhava Sheva', 'Felixstowe', '40HC', 'ONEY'), sellRate: 1475, status: 'Booked' },
  { quotationRefCustomer: 'FED Limited', quotationRefPol: 'Savannah', quotationRefPod: 'Dubai', quotationRefEquipment: '40GP', customerName: 'FED Limited', pol: 'Savannah', pod: 'Dubai', equipment: '40GP', type: 'Export', buyRate: findBuyRate('Savannah', 'Dubai', '40GP', 'HLCU'), sellRate: 1100, status: 'Booked' },
  { quotationRefCustomer: 'DEF Limited', quotationRefPol: 'Felixstowe', quotationRefPod: 'Savannah', quotationRefEquipment: '40GP', customerName: 'DEF Limited', pol: 'Felixstowe', pod: 'Savannah', equipment: '40GP', type: 'Export', buyRate: findBuyRate('Felixstowe', 'Savannah', '40GP', 'MAEU'), sellRate: 1150, status: 'Booked' },
];
