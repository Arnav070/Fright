...
export const quotationsToSeedFromImage: Omit<Quotation, 'id' | 'createdAt' | 'updatedAt' | 'profitAndLoss'>[] = [
  ...
  { customerName: 'ABC Limited', pol: 'Chennai', pod: 'Long Beach', volume: '1x20GP', equipment: '20GP', type: 'Export', buyRate: findBuyRate('Chennai', 'Long Beach', '20GP', 'HLCU'), sellRate: 1100, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'HLCU' && br.pol==='INMAA'&&br.pod==='USLGB'&&br.equipment==='20GP')?.id },
  { customerName: 'ABC Limited', pol: 'Chennai', pod: 'Long Beach', volume: '1x40GP', equipment: '40GP', type: 'Export', buyRate: findBuyRate('Chennai', 'Long Beach', '40GP', 'MAEU'), sellRate: 1200, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'MAEU' && br.pol==='INMAA'&&br.pod==='USLGB'&&br.equipment==='40GP')?.id },
  { customerName: 'ABC Limited', pol: 'Chennai', pod: 'Long Beach', volume: '1x40HC', equipment: '40HC', type: 'Export', buyRate: findBuyRate('Chennai', 'Long Beach', '40HC', 'MAEU'), sellRate: 1200, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'MAEU' && br.pol==='INMAA'&&br.pod==='USLGB'&&br.equipment==='40HC')?.id },
  // FED Limited, Savannah -> Dubai
  { customerName: 'FED Limited', pol: 'Savannah', pod: 'Dubai', volume: '1x20GP', equipment: '20GP', type: 'Export', buyRate: findBuyRate('Savannah', 'Dubai', '20GP', 'HLCU'), sellRate: 920, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'HLCU' && br.pol==='USSAV'&&br.pod==='AEDXB'&&br.equipment==='20GP')?.id },
  { customerName: 'FED Limited', pol: 'Savannah', pod: 'Dubai', volume: '1x40GP', equipment: '40GP', type: 'Export', buyRate: findBuyRate('Savannah', 'Dubai', '40GP', 'HLCU'), sellRate: 1100, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'HLCU' && br.pol==='USSAV'&&br.pod==='AEDXB'&&br.equipment==='40GP')?.id },
  { customerName: 'FED Limited', pol: 'Savannah', pod: 'Dubai', volume: '1x40HC', equipment: '40HC', type: 'Export', buyRate: findBuyRate('Savannah', 'Dubai', '40HC', 'HLCU'), sellRate: 1100, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'HLCU' && br.pol==='USSAV'&&br.pod==='AEDXB'&&br.equipment==='40HC')?.id },
  // DEF Limited, Felixstowe -> Savannah
  { customerName: 'DEF Limited', pol: 'Felixstowe', pod: 'Savannah', volume: '1x20GP', equipment: '20GP', type: 'Export', buyRate: findBuyRate('Felixstowe', 'Savannah', '20GP', 'ONEY'), sellRate: 850, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'ONEY' && br.pol==='GBFXS'&&br.pod==='USSAV'&&br.equipment==='20GP')?.id },
  { customerName: 'DEF Limited', pol: 'Felixstowe', pod: 'Savannah', volume: '1x40GP', equipment: '40GP', type: 'Export', buyRate: findBuyRate('Felixstowe', 'Savannah', '40GP', 'MAEU'), sellRate: 1150, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'MAEU' && br.pol==='GBFXS'&&br.pod==='USSAV'&&br.equipment==='40GP')?.id },
  { customerName: 'DEF Limited', pol: 'Felixstowe', pod: 'Savannah', volume: '1x40HC', equipment: '40HC', type: 'Export', buyRate: findBuyRate('Felixstowe', 'Savannah', '40HC', 'MAEU'), sellRate: 1150, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'MAEU' && br.pol==='GBFXS'&&br.pod==='USSAV'&&br.equipment==='40HC')?.id },
  // DEF Limited, Nhava Sheva -> Felixstowe
  { customerName: 'DEF Limited', pol: 'Nhava Sheva', pod: 'Felixstowe', volume: '1x20GP', equipment: '20GP', type: 'Export', buyRate: findBuyRate('Nhava Sheva', 'Felixstowe', '20GP', 'MAEU'), sellRate: 1100, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'MAEU' && br.pol==='INNSA'&&br.pod==='GBFXS'&&br.equipment==='20GP')?.id },
  { customerName: 'DEF Limited', pol: 'Nhava Sheva', pod: 'Felixstowe', volume: '1x40GP', equipment: '40GP', type: 'Export', buyRate: findBuyRate('Nhava Sheva', 'Felixstowe', '40GP', 'ONEY'), sellRate: 1475, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'ONEY' && br.pol==='INNSA'&&br.pod==='GBFXS'&&br.equipment==='40GP')?.id },
  { customerName: 'DEF Limited', pol: 'Nhava Sheva', pod: 'Felixstowe', volume: '1x40HC', equipment: '40HC', type: 'Export', buyRate: findBuyRate('Nhava Sheva', 'Felixstowe', '40HC', 'ONEY'), sellRate: 1475, status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.carrier === 'ONEY' && br.pol==='INNSA'&&br.pod==='GBFXS'&&br.equipment==='40HC')?.id },
  // BCD Limited (LCL), Shanghai -> Long Beach
  { customerName: 'BCD Limited', pol: 'Shanghai', pod: 'Long Beach', volume: '11 CBM', equipment: 'LCL', type: 'Import', buyRate: (findBuyRate('Shanghai', 'Long Beach', 'LCL') * 11), sellRate: (70 * 11), status: 'Draft', selectedRateId: initialMockBuyRates.find(br=>br.pol==='CNSGH'&&br.pod==='USLGB'&&br.equipment==='LCL')?.id },
];
